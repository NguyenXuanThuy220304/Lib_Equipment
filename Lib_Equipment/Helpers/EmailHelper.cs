    ...
    public static class EmailHelper
    {
        ...
        public static bool SendNoticeEmail(string toEmail, string readerName, string readerID, decimal amount, string type)
        {
            try
            {
                ...
                string body = $@"
                <div style='font-family: Segoe UI, Arial; max-width: 600px; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;'>
                    ...
                    <div style='padding: 30px; line-height: 1.6; color: #333;'>
                        ...
                        <table style='width: 100%; border-collapse: collapse; margin: 20px 0;'>
                            <tr style='background-color: #f8f9fa;'>
                                <td style='padding: 10px; border: 1px solid #ddd;'><b>Mã Độc giả:</b></td>
                            ...
                            <tr style='color: #d93025;'>
                                ...
                                <td style='padding: 10px; border: 1px solid #ddd;'><b>{amount:N0} VNĐ</b></td>
                            </tr>
                        </table>
                        ...
                        <p>Vui lòng đến văn phòng Thư viện để giải quyết sớm nhất.</p>
                    </div>
                    <div style='background-color: #f1f1f1; padding: 15px; text-align: center; font-size: 12px; color: #777;'>
                        Đây là thư gửi tự động từ hệ thống quản lý. Vui lòng không trả lời thư này.
                    </div>
                </div>";
